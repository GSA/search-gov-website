...
Use an [alert](https://designsystem.digital.gov/components/alert/) to keep the public informed of important and sometimes time-sensitive changes.

For example, after a [website redesign]({{ site.baseurl }}/indexing/redesign.html), you can use an alert to tell searchers about this update. 

Visit the Search Page Alert page in the [Admin Center](https://search.usa.gov/sites) to add an alert. Enter a title and text for the alert and set the status to active. Then, save it to turn on the alert.
