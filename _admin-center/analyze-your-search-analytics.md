---
layout: page
title: How to analyze your search analytics
category: admin-center
tags: help-manual analytics queries clicks monthly-reports third-party dap referrers
...
redirect_from:
    - /manual/queries.html
    - /admin-center/analytics/index.html
    - /admin-center/analytics/queries.html
    - /admin-center/analytics/clicks.html
    - /admin-center/analytics/monthly-reports.html
    - /admin-center/analytics/referrers.html
    - /admin-center/analytics/third-party.html
---
...
Review the search terms visitors use on your website on the Queries page in the [Admin Center](https://search.usa.gov/sites).
...
Review the pages searchers click on the Clicks page in the [Admin Center](https://search.usa.gov/sites).
...
Review the pages visitors are on when they search on the Referrers page in the [Admin Center](https://search.usa.gov/sites).
...
Visit the Monthly Reports page in the [Admin Center](https://search.usa.gov/sites) for a snapshot of the total queries and clicks for the current month. You can change the time period by using the generate report option.
