...
The following APIs are available for use on official government websites only. You must be a Search.gov customer with an [active user account]({{ site.baseurl }}/get-started/account.html) to use them.
...
Check out this [feature comparison]({{ site.baseurl }}/admin-center/display/hosted-vs-api-results.html) for more information on the differences between using our APIs and the hosted search results page.
