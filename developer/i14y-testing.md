...
If you experience difficulty sending documents to our index via [i14y]({{ site.url }}/developer/i14y.html), it is possible your firewall is not letting you communicate with the i14y server. Adding a test document to your i14y drawer can help you diagnose a firewall issue.
...
After successfully sending a document, you should see an increase (by 1) in the number of documents in your [i14y drawer]({{ site.url }}/developer/i14y-drawers.html).
...
***Resources:*** Read tips on [Getting Started With i14y]({{ site.url }}/developer/i14y.html), or view the full [i14y technical documentation]({{ site.url }}/developer/indexing-api.html).
