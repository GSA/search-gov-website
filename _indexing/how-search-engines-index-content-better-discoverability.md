...
* Leave the item in the [sitemap]({{ site.baseurl }}/indexing/sitemaps.html), so that search engines will see the page was updated, revisit it, and see that the item should be removed from the index.
