...
<i class="icon-check"></i> **8. Do you have our Javascript tag on your webpages?** This Javascript powers the suggestions for typeahead and [related searches]({{ site.url }}/admin-center/display/display-overview.html). It also provides data on your trending URLs on the [Site Overview]({{ site.url }}/admin-center/dashboard/site-overview.html) page in the [Admin Center](https://search.usa.gov/sites/).
