...
[Simple XML Sitemap Module](https://www.drupal.org/project/simple_sitemap) plus a [contributed patch to add static files](https://www.drupal.org/files/issues/2021-06-30/simple_sitemap-files-support-2947456-29.patch) {% external_link %}

### Wordpress

[Yoast SEO Plugin](https://wordpress.org/plugins/wordpress-seo/) {% external_link %}

[All In One SEO Plugin](https://wordpress.org/plugins/all-in-one-seo-pack/) {% external_link %}
...
### Online generators
(Note: These links are not an endorsement. Online generators may require payment, or impose a limit to the number of URLs they will include, and do not always generate the most accurate sitemaps. Use them after thorough testing.)

[Free Sitemap Generator](https://freesitemapgenerator.com) {% external_link %}

[PRO Sitemaps](https://pro-sitemaps.com/) {% external_link %}
