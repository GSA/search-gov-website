...
Example: [https://search.gov/sitemap.xml]({{ site.url }}{{ site.baseurl }}/sitemap.xml)
...
Read more about [robots.txt files]({{ site.url }}{{ site.baseurl }}/blog/robotstxt.html), and take a look at ours: [https://search.gov/robots.txt]({{ site.url }}{{ site.baseurl }}/robots.txt)
