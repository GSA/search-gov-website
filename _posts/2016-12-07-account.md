...
[Search.gov Home]({{ site.baseurl }}/index.html) > [Admin Center](https://search.usa.gov/sites/){% onClick="ga('send', 'event', { eventCategory: 'outbound', eventAction: 'login', eventLabel: 'in-page'});" %} > My Account

You can use Search.gov to power the search box on your federal government website&mdash;at no cost.

## Log In

Log in to an existing account <https://search.usa.gov/login>{% onClick="ga('send', 'event', { eventCategory: 'outbound', eventAction: 'login', eventLabel: 'in-page'});" %} or register for a new account at <https://search.usa.gov/signup>{% onClick="ga('send', 'event', { eventCategory: 'outbound', eventAction: 'sign-up', eventLabel: 'in-page'});" %}.
...
Once your account is approved, you can [add a site]({{ site.baseurl }}/manual/add-site.html) in our [Admin Center](https://search.usa.gov/sites/).
...
1. Go to our Login page at <https://search.usa.gov/login>{% onClick="ga('send', 'event', { eventCategory: 'outbound', eventAction: 'login', eventLabel: 'in-page'});" %}
