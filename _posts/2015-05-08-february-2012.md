...
* Searchers see near-real-time [type-ahead]({{ site.baseurl }}/manual/typeahead-api.html) suggestions.
* Searchers see a custom header image on results pages.
* Searchers may narrow results by [collections]({{ site.baseurl }}/manual/collections.html) in left nav.
