...
* Directing non-cached traffic between our two datacenters to create a [multihomed environment]({{ site.baseurl }}/releases/2012-10-19.html). Multihoming allows us to make full use of all of our servers. By contrast, in 2010, our disaster recovery datacenter often sat idle.
