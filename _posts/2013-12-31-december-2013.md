...
* We replaced Jenkins with [Travis CI](https://travis-ci.org/).
* We fixed a time setting on our API machine.
* We upgraded Java on our API and [Cloudera](http://www.cloudera.com/content/cloudera/en/home.html) machines.
