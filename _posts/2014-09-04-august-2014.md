...
* Searchers now see [Dublin Core](http://dublincore.org/documents/dcmi-terms/) facets on the [newly redesigned search results page]({{ site.baseurl }}/blog/serp-redesign.html).
...
* To improve the quality of typeahead suggestions, we decreased the number of times a term must be searched before appearing as a suggestion.
