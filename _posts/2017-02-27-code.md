...
Leave your domain blank on the [Domains]({{ site.baseurl }}/manual/domains.html) page and, instead, pass a hidden value for the domain in the search form code.
...
***Did you know?*** We offer [DNS masking]({{ site.baseurl }}/manual/cname.html), which allows you to show searchers your domain (instead of USA.gov).
