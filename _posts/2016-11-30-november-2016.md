...
* When you [clone a search configuration]({{ site.baseurl }}/admin-center/dashboard/clone-site.html), your typeahead suggestions will no longer clone to the new configuration. This enables your new site to populate typeahead suggestions based on its own traffic.
