...
<div class='signup-wrapper'>
  <a href="https://search.usa.gov/signup" class="btn btn-primary btn-large" onClick="ga('send', 'event', { eventCategory: 'outbound', eventAction: 'login', eventLabel: 'in-page'});">Federal agencies, try our service today!</a>
</div>
