...
![Videos Facet on DigitalGov.gov]({{ site.baseurl }}/img/Videos-Facet.png "Videos Facet on DigitalGov.gov"){:height="95%" width="95%"}

**Inline Module**

![Inline Module on DigitalGov.gov]({{ site.baseurl }}/img/Videos-Inline-Module.png "Inline Module on DigitalGov.gov"){:height="95%" width="95%"}
