...
As searchers type in their query, relevant [text Best Bets]({{ site.baseurl }}/manual/best-bets-text.html) are shown as Recommended Pages, as shown in the sample below for a search on [*fa&#8230;* on DOL.gov](https://search.usa.gov/search?query=jobs&amp;affiliate=u.s.departmentoflabor).
