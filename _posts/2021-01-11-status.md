...
Details: 5:05 ET - Additional resources are fully deployed, some image searches may fail for the next few minutes while we finalize the builds.<br />
4:25PM ET - We've added processing resources to handle the increase in query load. We believe the system has stabilized and are continuing to monitor. We'll update in another 30 minutes to confirm. <br /><br />
3:55PM ET - Beginning shortly after 3pm ET, most search services went down due to a sudden and significant query load. The system is beginning to recover; we are adding resources. We're actively monitoring the situation and will post updates here every 30 minutes. <br />
