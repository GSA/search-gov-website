...
![Flowchart showing the major phases of search indexing: Discover, Parse, Index, and Search.]({{ site.url }}/assets/img/site/basic-indexing-flow.png)

[*Detailed diagram*]({{ site.url }}/assets/img/site/searchgov-flow.png)
...
Since 2015, we’ve offered an API called [i14y]({{ site.url }}/developer/i14y.html). I14y receives real-time content updates, which gives you full control over your search results. You can update and remove content, and decide exactly what will be shown as the result title for each item.
...
We are excited about our new direction. You can follow our progress by reading our monthly [Release Notes]({{ site.url }}/about/updates/releases/).
...
We encourage you to explore how you can compile a list of your site URLs, and to begin thinking about cleaning up your page titles and descriptions. You do not need to send us any information yet. You may want to check out our webinar [Structuring Your Site for Better SEO]({{ site.url }}/get-started/training.html) that will give you tips on what sorts of things to be on the watch for.
...
We also invite you to read our [FAQs]({{ site.url }}/blog/searchgov-faqs-indexing.html), which we'll update regularly.

Finally, we welcome you to email [questions and comments](mailto:search@support.digitalgov.gov).

The Search program has grown and evolved since its [inception in September 2000]({{ site.url }}/about/customers.html). We look forward to this next phase of service to you and the public. 
