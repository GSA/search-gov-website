...
<img src="https://search.gov/assets/img/site/green-status-normal-operations.png" width="15px" height="15px" alt="Outage" title="Outage">&nbsp;&nbsp;&nbsp; Outage

**May 5, 2020 - 5:00 PM ET:** Search.gov is currently down, and the team is currently investigating the cause. We are attempting to restore service and will provide updates every 30 minutes.
