...
1. Read our [Search Site Launch Guide]({{ site.url }}{{ site.baseurl }}/manual/getting-started.html) if you’d like some direction.
...
1. [Preview your search results]({{ site.url }}{{ site.baseurl }}/manual/preview.html) once the indexing is complete.
