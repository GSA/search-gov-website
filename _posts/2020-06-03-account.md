...
1. Sign in at Login.gov with your email address and password, and provide your second factor of authentication (PIV/CAC card, code receive via SMS, etc.) <br />![Screenshot showing Login.gov sign in page]({{ site.baseurl }}/assets/img/site/login_gov-sign-in-page.png)
