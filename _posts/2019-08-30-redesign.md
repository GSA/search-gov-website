...
**What:** We will ask you about your search needs for the new site, including what domains you need to include, how you can generate an [xml sitemap](/blog/sitemaps.html), and what SEO supports you’re putting in place in your new templates, like [metadata](/manual/metadata.html) and [other structured elements](/manual/how-search-engines-index-content-better-discoverability.html). Read more about our [indexing process here](/manual/site-launch-guide.html#indexing-workflow).
...
* Ensure that each domain and subdomain you want to be searchable launches with an [xml sitemap](/blog/sitemaps.html).
* Add [metadata](/manual/metadata.html) blocks to the `<head>` of your page templates, and Semantic Markup to the `<body>`. 
...
**What:** Use our [Search Page Alert](/manual/system-alert.html) feature to display a “pardon our dust” type message on your results page. For example:
...
**What:** Gather your [new logo and color palette](/manual/brand.html), if needed. Many sites find it helpful to mock up their redesigned results page in a non-production search site - you can either [clone](/manual/clone-site.html) your existing site or just use the [Add Site](/manual/add-site.html) button to create a totally new one.
...
* [Domains](/manual/domains.html): make sure your Domains list includes the domains and subdomains that you want included as the default content to search.
* [Collections](/manual/collections.html): make sure your Collections are searching for the right content in the new location.  
* [Best Bets](/manual/best-bets.html): make sure your Best Bet URLs are correct for the content’s new location.
* [Routed Queries](/manual/routed-queries.html): update the target of your Routed Queries, so searchers will end up on the correct page.
* [RSS](/manual/rss.html) feeds should be removed, and re-added from their new locations.
