...
[Search.gov Home]({{ site.baseurl }}/index.html) > [Admin Center](https://search.usa.gov/sites/) > YourSite > Manage Content > Best Bets: Text or Graphics
...
***URL.*** Add the URL of the web page that you want to promote. Make sure the URL is properly formatted, and includes the protocol (`https://`).
...
* Required fields:
  * Title
  * URL. Make sure the URL is properly formatted, and includes the protocol (`https://`). 
  * Description 
* Optional fields:
  * Start date
  * End date
