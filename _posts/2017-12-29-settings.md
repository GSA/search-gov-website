...
[![Site name and handle on SocialSecurity.gov's search results page](https://d3qcdigd1fhos0.cloudfront.net/blog/img/settings.png "Site name and handle on SocialSecurity.gov's search results page")](https://search.socialsecurity.gov/search?query=office+locations&affiliate=ssa)
