...
This documentation will walk you through setting up the `usasearch` [Drupal 7 module](https://drupal.org/project/usasearch){% external_link %} field by field, to integrate your Drupal CMS with the Search.gov service. If you have trouble, take a look at our [troubleshooting tips]({{ site.baseurl }}/manual/drupal-module-troubleshooting.html). 
...
Instructions for setting up the **Drupal 8** module are [here]({{ site.baseurl }}/manual/drupal-8-module-instructions.html).
