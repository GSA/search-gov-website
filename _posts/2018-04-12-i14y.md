...
If you use a different CMS, or don't have one at all, we recommend you focus on publishing a comprehensive [xml sitemap]({{ site.baseurl }}/blog/sitemaps.html), which we would leverage to index your content.
