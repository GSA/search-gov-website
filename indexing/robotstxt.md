...
### XML Sitemaps
Your robots.txt file should also list one or more of your [XML sitemaps]({{ site.url }}/indexing/sitemaps.html). For example:
...
<i class="icon-check"></i> 3. The robots.txt file lists one or more [XML sitemaps]({{ site.url }}/indexing/sitemaps.html)  
